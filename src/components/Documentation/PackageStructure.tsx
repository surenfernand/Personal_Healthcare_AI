...
export const PackageStructure = () => {
  ...
  return (
    <div id="structure" className="md:scroll-m-[130px] scroll-m-28 relative z-10 before:absolute before:w-1/2 before:h-1/2 before:bg-gradient-to-br before:from-primary before:to-secondary before:blur-390 before:z-0 before:-left-36">
