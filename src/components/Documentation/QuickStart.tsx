  ...
  return (
    <div className="pb-10 md:scroll-m-[180px] scroll-m-28" id="start">
      ...
      <div className="p-6 rounded-md border mt-6 border-white/60">
        ...
        <ul className="list-disc text-white/60 text-opacity-60 ps-6">
          <li>node js 20+</li>
          <li>npm js 10+</li>
        </ul>
      </div>
      <div className="p-6 rounded-md border mt-6 border-white/60 relative before:absolute before:w-full before:h-full before:bg-gradient-to-br before:from-primary before:to-secondary before:blur-390 before:-right-32">
      ...
      <div className="p-6 rounded-md border mt-6 border-white/60">
        ...
        <p className="text-base font-medium text-white/60 text-opacity-60 mb-4">
        ...
        <p className="text-base font-medium text-white/60 text-opacity-60 my-4">
          This command will start a local webserver{" "}
          <span className="dark:text-white">http://localhost:3000:</span>
        </p>
        <div className="py-4 px-3 rounded-md bg-dark_grey">
          <p className="text-sm text-gray-400">
            {"> Personal_Healthcare_project@2.0.0 dev"}
          </p>
      ...
      <div className="p-6 rounded-md border mt-6 border-white/60">
        ...
        <p className="text-base font-medium text-white/60 text-opacity-60 mt-6">
